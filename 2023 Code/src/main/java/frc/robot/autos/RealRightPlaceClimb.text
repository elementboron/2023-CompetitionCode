...
public class RealRightPlaceClimb extends SequentialCommandGroup {

    
    public RealRightPlaceClimb(Swerve s_Swerve, RotateArmMotor s_Arm, WristMotor s_Wrist, GripperWheels s_Wheels){
    ...
    thetaController.enableContinuousInput(-Math.PI, Math.PI);
        ...
        Trajectory driveToCone =
            TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(4.75, 2.5, new Rotation2d(0)),
                config);
