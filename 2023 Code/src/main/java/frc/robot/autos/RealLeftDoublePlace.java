...
public class RealLeftDoublePlace extends SequentialCommandGroup {

    
    public RealLeftDoublePlace(Swerve s_Swerve, RotateArmMotor s_Arm, WristMotor s_Wrist, GripperWheels s_Wheels, Pneumatics s_Pneumatics){
    ...
    thetaController.enableContinuousInput(-Math.PI, Math.PI);
        ...
        Trajectory driveToCone =
            TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(4.53, -0.35, new Rotation2d(0)),
                config);
        ...
        Trajectory driveBack =
            TrajectoryGenerator.generateTrajectory(
                ...
                // End 3 meters straight ahead of where we started, facing forward
                new Pose2d(4.7, 0.2, new Rotation2d(0)),
                config);
