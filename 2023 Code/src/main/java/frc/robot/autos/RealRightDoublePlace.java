...
public class RealRightDoublePlace extends SequentialCommandGroup {
    ...
    public RealRightDoublePlace(Swerve s_Swerve, RotateArmMotor s_Arm, WristMotor s_Wrist, GripperWheels s_Wheels, Pneumatics s_Pneumatics){
    ...
    thetaController.enableContinuousInput(-Math.PI, Math.PI);
        ...
        Trajectory driveToCone =
            TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(4.53, 0.23, new Rotation2d(0)),
                config);
