...
public class RealRightPlaceGrabClimb extends SequentialCommandGroup {

    
    public RealRightPlaceGrabClimb(Swerve s_Swerve, RotateArmMotor s_Arm, WristMotor s_Wrist, GripperWheels s_Wheels){
